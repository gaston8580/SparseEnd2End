...
def e2e_trt_inference(model, data_loader, args):
    ...
    for i, data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            if i == 0:
                ## inference
                inputs1st = (img, image_wh, lidar2img, ego_his_trajs)
            ...
            results.append(result['plan_traj'])
...
def parse_args():
    ...
    parser.add_argument("--compare_num", default=5, help='compare number of torch and trt outputs.',)
