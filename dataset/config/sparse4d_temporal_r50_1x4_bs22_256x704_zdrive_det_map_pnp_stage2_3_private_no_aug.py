...
class_names = [
    ...
    "tricycle", "bicycle","motorcycle", "person",
...
model = dict(
    ...
    head=dict(
        ...
        instance_bank=dict(
            ...
            anchor="/home/com0109/liuxu/Project/end2end_algorithm_branches/vis/end2end_algorithm/data/kmeans_det_900_zdrive.npy",
    ...
    map_head=dict(
        ...
        instance_bank=dict(
            ...
            num_anchor=100,
            embed_dims=embed_dims,
            anchor="/home/com0109/liuxu/Project/end2end_algorithm_branches/vis/end2end_algorithm/data/kmeans_map_100_zdrive.npy",
...
data = dict(
    ...
    train=dict(
        **data_basic_config,
        ...
        ann_file="/media/com0109/d326c99f-2622-4ca8-b10c-1cb533e255af/dataset/ali_odd/annos_1218",
